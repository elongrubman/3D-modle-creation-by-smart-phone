...
//    grid3D grid(0.05, &frame1);
    Matx31f point_grid_center(image1_first_features[102].x,image1_first_features[102].y,image1_first_features[102].z);
...
//    testProjection(image1_first_features, images_path, frames_vector, &cntr2);
    ...
    Matx31f direction_vector(0,0, -1);
    Matx31f point(0,0, 4);
    straight_line_equation l(direction_vector, point);
    ...
    vector<voxel> entrance_voxel = grid.getVoxelFromCoordinatesOrPush(entrance_point(0,0), entrance_point(1,0), entrance_point(2,0), keys);
